...
class XeroDiscover(XeroScenarioBase):
    """
    ...
    def name(self):
        return "tap_tester_xero_discover_test"
    ...
    def test_run(self):
        ...
        for stream in streams_to_test:
            with self.subTest(stream=stream):
                ...
                expected_primary_keys = set(self.expected_pks[stream])
                expected_replication_keys = set(self.expected_bookmarks[stream])
